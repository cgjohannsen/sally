...
if (BTOR2TOOLS_HOME)
  ...
  find_path(BTOR2TOOLS_INCLUDE_DIR btor2parser/btor2parser.h PATHS "${PROJECT_SOURCE_DIR}/contrib/btor2tools/src")
endif()
...
if (SALLY_STATIC_BUILD)
  if (BTOR2TOOLS_HOME)
    ...
    find_library(BTOR2TOOLS_LIBRARY libbtor2parser.a btor2parser PATHS "${PROJECT_SOURCE_DIR}/contrib/btor2tools/build/lib")
  endif()
else()
  if (BTOR2TOOLS_HOME)
    find_library(BTOR2TOOLS_LIBRARY btor2parser PATHS "${BTOR2TOOLS_HOME}/build/lib" NO_DEFAULT_PATH)
  else()
    find_library(BTOR2TOOLS_LIBRARY btor2parser PATHS "${PROJECT_SOURCE_DIR}/contrib/btor2tools/build/lib")
  endif()
endif()
